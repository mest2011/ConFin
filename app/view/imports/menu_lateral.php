...
<div class="collapse navbar-collapse d-md-block no-display" id="navbarNav">
    <div class="menu-lateral d-md-inline">
        ...
        <div class="menu-expand mobile-off">
            <div class="d-flex pt-4 selectable-none align-items-baseline mobile-off align-menu-icons">
                <h4 class="font-white mb-0">Cofrin</h4>
                <img class="logo" src="./images/logo_porquinho.png" alt="Logo do porquinho">
            </div>
        </div>

        <ul class="d-block mobile-margin-menu">
            <a class="font-gray d-flex py-4 align-menu-icons menu-opcoes mobile-off" href="../view/dashboard.php" title="Ir para dashboard">
            ...
            <a class="font-gray d-flex py-4 align-menu-icons menu-opcoes" href="../view/ganhos.php" title="Ver todos os ganhos do mês">
            ...
            <a class="font-gray d-flex py-4 align-menu-icons menu-opcoes" href="../view/gastos.php" title="Ver todas as despesas do mês">
            ...
            <a class="font-gray d-flex py-4 align-menu-icons menu-opcoes" href="../view/extrato.php" title="Ver extrato do mês">
            ...
            <a class="font-gray d-flex py-4 align-menu-icons menu-opcoes" href="../view/carteiras.php" title="Ver todas as carteiras cadastradas!">
