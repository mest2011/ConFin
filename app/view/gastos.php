...
<body class="d-flex flex-wrap" onload="loadCards()">
    ...
    <script>
        ...
        const loadCards = async (filter = false) => {
            ...
            const response = await fetch(`../controller/gastos_controller.php`, requestOptions)
                            ...
                            <div class=\"d-flex w-100\">
                                ...
                                <div class=\"my-auto d-flex w-100 justify-content-between flex-wrap\">
                                    ...
                                    <div class=\"my-auto d-flex\">
                                        <h4 class=\"font-red number my-auto\">R$${resultJson[i]['valor']}</h4>
                                        <p class="hover-red hover-bg-gray my-auto mx-2 p-1 font-weight-bold" onmouseover="this.innerText = 'Excluir?'" onmouseout="this.innerText = '. . .'" onclick="
                                            ...
                                            if(confirm('Deseja mesmo excluir esse gasto?')){
                                                deletarGasto(${resultJson[i]['id_despesa']});
                                            }
                                            ">. . .<p>
                                    </div>
                                </div>
        ...
        function loadSideModal(id = '',
            ...
            sideModal.innerHTML = `
                ...
                <div class="d-flex">
                        ...
                        <div class="w-100">
                            <input class="form-control font-title-modal h-100" type="text" id="form-title" name="form-title" value="${titulo}" maxlength="30" placeholder="Titulo da despesa" onclick="loadSuggestion()" onfocusout="setTimeout(()=>closeSuggestion(), 250)" onkeydown="closeSuggestion()" autocomplete="off" required>
